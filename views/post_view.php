...
foreach ($items as $item):
    $profile = getUserInfo($item['user_id']);
    ?>
            ...
            <ul role="list" class="p-0 divide-y divide-slate-200">
                <li class="flex py-4 first:pt-0 last:pb-0">
                    ...
                    <div class="ml-3 overflow-hidden w-1/2">
                        <p class="text-lg font-bold text-slate-900"><?= $profile['first_name']. ' '. $profile['last_name']?></p>
                    ...
                    <div class="text-right w-1/2 relative">
                        <i class="control-post fa fa-ellipsis-h cursor-pointer text-blue-400 text-[25px]" style="<?= $profile['user_id']!=$_SESSION['user_id']? "display:none":"";?>"></i>
